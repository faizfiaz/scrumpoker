// ignore_for_file: implementation_imports, prefer_asserts_with_message
...
class IntroductionScreenState extends State<IntroductionScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final isSkipBtn = !_isSkipPressed && !isLastPage && widget.showSkipButton;
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        ...
                        child: isSkipBtn
                            ? skipBtn
                            : Opacity(opacity: 0, child: skipBtn),
                      ),
                      Expanded(
                      ...
                      Expanded(
                        ...
                        child: isLastPage
                            ...
                            : widget.showNextButton
                                ? nextBtn
                                : Opacity(opacity: 0, child: nextBtn),
                      ),
                    ],
                  ),
                ),
